...
export default function TherapistDashboard() {
  ...
  const overviewStats = [
    { title: 'Active Child Profiles', value: '24', icon: Users, color: 'text-teal-600' },
    { title: 'Upcoming Sessions', value: '8', icon: Calendar, color: 'text-green-600' },
    { title: 'Pending Assessments', value: '5', icon: FileText, color: 'text-orange-600' },
  ];

  const recentNotifications = [
    { id: 1, type: 'assessment', child: 'Ahmad Khan', message: 'New assessment results available', time: '2 hours ago' },
    { id: 2, type: 'update', child: 'Fatima Ali', message: 'Caregiver added new observations', time: '4 hours ago' },
    { id: 3, type: 'session', child: 'Hassan Ahmed', message: 'Session scheduled for tomorrow', time: '1 day ago' },
  ];
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="mt-2 text-gray-600">Here's what's happening with your patients today.</p>
        </div>
                ...
                {recentNotifications.map((notification) => (
                  <div key={notification.id} className="flex items-start space-x-3 p-3 bg-gray-50 rounded-lg">
                    <div className="flex-1">
                      <p className="text-sm">
                        <span className="font-medium">{notification.child}</span> - {notification.message}
                      </p>
